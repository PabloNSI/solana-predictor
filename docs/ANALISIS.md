...
Nota: Las conclusiones están respaldadas por los resultados de evaluación almacenados en `notebooks/model_info.json` (test_mae ≈ 6.85, test_rmse ≈ 9.24, test_r2 ≈ 0.934) que se usan como evidencia empírica para la selección del modelo.